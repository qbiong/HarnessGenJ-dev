...
/* Section display */
.tab-section {{ display: none; width: 100%; height: 100%; overflow-y: auto; }}
...
.chat-input-area {{ padding: 12px 20px 16px; border-top: 1px solid var(--border); background: var(--bg-primary); }}
